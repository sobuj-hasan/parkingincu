                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="card-box p-5">
                            <h4 class="m-t-0 m-b-30 header-title mb-4"><strong>Change Password</strong> <a class="btn btn-sm btn-info float-right" href="{{ route('dashboard.index') }}" title=""> < Back Profile </a></h4>
